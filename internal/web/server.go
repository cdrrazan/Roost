 ...
 <div class="content" id="top">
  ...
  <main>
   ...
   <section id="dash">
    ...
    #dash .dcard{background:var(--panel2);border:1px solid var(--line);border-radius:16px;padding:14px 16px;min-width:0;height:320px;display:flex;flex-direction:column;overflow:hidden}
