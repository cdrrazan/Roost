...
window.FLEET = {
  ...
  apps: [
    { name: "analytics",  category: "main",    framework: "next",    db: "postgres", redis: false, runtime: "node-20",  state: "running", url: "https://analytics.example.com", repo: "https://github.com/acme/analytics", http: "200", cpu: 3.4,  mem: 412, cap: 768,  up: "Up 6 days",  restarts: 0, health: "healthy", env: ["DATABASE_URL","NEXT_PUBLIC_API","SESSION_SECRET"] },
    { name: "billing",    category: "main",    framework: "rails",   db: "mysql",    redis: true,  runtime: "ruby-3.3", state: "running", url: "https://billing.example.com",   repo: "https://github.com/acme/billing",   http: "200", cpu: 1.9,  mem: 305, cap: 512,  up: "Up 6 days",  restarts: 0, health: "healthy", env: ["DATABASE_URL","REDIS_URL","STRIPE_KEY"] },
